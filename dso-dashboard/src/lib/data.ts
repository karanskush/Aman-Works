...
export const revenueAtRiskData = {
  ...
  insight: {
    businessPurpose:
      "Quantifies the share of booked revenue that may not convert to cash, calculated specifically for customers with 45-60 day credit terms.",
    formula:
      "Revenue at Risk = (Overdue AR for 45-60 day credit invoices / Total Revenue) x 100",
    aiInsight:
...
export const agingBucketData = {
  ...
  insight: {
    businessPurpose:
      "Shows receivable concentration across time-since-invoice bands. Healthy: 60%+ in 0-30 days. Inverted pyramid (majority in 45-60 days) = high default risk.",
    formula:
...
export const invoiceToCashData = {
  ...
  insight: {
    ...
    formula:
      "I2C = Percentile of (Cash Receipt Date − Invoice Issue Date) across all invoices",
    aiInsight:
